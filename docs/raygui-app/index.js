...
var ASM_CONSTS = {
  1084720: () => { if (document.fullscreenElement) return 1; },  
 1084766: () => { return document.getElementById('canvas').width; },  
 1084818: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1084886: () => { document.exitFullscreen(); },  
 1084913: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1084986: () => { if (document.fullscreenElement) return 1; },  
 1085032: () => { return document.getElementById('canvas').width; },  
 1085084: () => { return screen.width; },  
 1085109: () => { document.exitFullscreen(); },  
 1085136: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1085269: () => { return window.innerWidth; },  
 1085295: () => { return window.innerHeight; },  
 1085322: () => { if (document.fullscreenElement) return 1; },  
 1085368: () => { return document.getElementById('canvas').width; },  
 1085420: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1085488: () => { if (document.fullscreenElement) return 1; },  
 1085534: () => { return document.getElementById('canvas').width; },  
 1085586: () => { return screen.width; },  
 1085611: () => { return window.innerWidth; },  
 1085637: () => { return window.innerHeight; },  
 1085664: () => { if (document.fullscreenElement) return 1; },  
 1085710: () => { return document.getElementById('canvas').width; },  
 1085762: () => { return screen.width; },  
 1085787: () => { document.exitFullscreen(); },  
 1085814: () => { if (document.fullscreenElement) return 1; },  
 1085860: () => { return document.getElementById('canvas').width; },  
 1085912: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1085980: () => { document.exitFullscreen(); },  
 1086007: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1086065: () => { return screen.width; },  
 1086090: () => { return screen.height; },  
 1086116: () => { return window.screenX; },  
 1086143: () => { return window.screenY; },  
 1086170: () => { return window.devicePixelRatio; },  
 1086206: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1086259: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1086330: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1086387: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1086643: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1086714: () => { if (document.fullscreenElement) return 1; },  
 1086760: () => { return window.innerWidth; },  
 1086786: () => { return window.innerHeight; },  
 1086813: () => { if (document.pointerLockElement) return 1; }
};
