...
var ASM_CONSTS = {
  1084568: () => { if (document.fullscreenElement) return 1; },  
 1084614: () => { return document.getElementById('canvas').width; },  
 1084666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1084734: () => { document.exitFullscreen(); },  
 1084761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1084834: () => { if (document.fullscreenElement) return 1; },  
 1084880: () => { return document.getElementById('canvas').width; },  
 1084932: () => { return screen.width; },  
 1084957: () => { document.exitFullscreen(); },  
 1084984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1085117: () => { return window.innerWidth; },  
 1085143: () => { return window.innerHeight; },  
 1085170: () => { if (document.fullscreenElement) return 1; },  
 1085216: () => { return document.getElementById('canvas').width; },  
 1085268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1085336: () => { if (document.fullscreenElement) return 1; },  
 1085382: () => { return document.getElementById('canvas').width; },  
 1085434: () => { return screen.width; },  
 1085459: () => { return window.innerWidth; },  
 1085485: () => { return window.innerHeight; },  
 1085512: () => { if (document.fullscreenElement) return 1; },  
 1085558: () => { return document.getElementById('canvas').width; },  
 1085610: () => { return screen.width; },  
 1085635: () => { document.exitFullscreen(); },  
 1085662: () => { if (document.fullscreenElement) return 1; },  
 1085708: () => { return document.getElementById('canvas').width; },  
 1085760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1085828: () => { document.exitFullscreen(); },  
 1085855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1085913: () => { return screen.width; },  
 1085938: () => { return screen.height; },  
 1085964: () => { return window.screenX; },  
 1085991: () => { return window.screenY; },  
 1086018: () => { return window.devicePixelRatio; },  
 1086054: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1086107: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1086178: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1086235: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1086491: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1086562: () => { if (document.fullscreenElement) return 1; },  
 1086608: () => { return window.innerWidth; },  
 1086634: () => { return window.innerHeight; },  
 1086661: () => { if (document.pointerLockElement) return 1; }
};
